  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-4.mb-lg-0.mb-3(data-aos="fade-right")
        p.mb-0 Se ha decidido crear un solo epígrafe para las pruebas tanto unitarias como de integración dado que, por la naturaleza del propio programa, Unity y de los juegos como software desarrollado es casi imposible encontrar elementos aislados de código que funcionen sin depender de otros.
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-9(data-aos="fade-right")
        .tarjeta.p-4(style="background-color: #E8EAFF")
          p.mb-0 Algo que la mayoría de las veces solemos dejar completamente de lado a la hora de desarrollar nuevas features en nuestros juegos son, sin duda, los Unit Tests.
            br
            br
      ...
      .col-md.tarjeta.color-primario.p-5
        ...
        ul.lista-ul--color
          li.d-flex
            ...
            p.mb-0 Aplicar test en nuestro código nos da seguridad y confianza en el comportamiento esperado de las lógicas que implementamos.
          li.d-flex
            i.fas.fa-gamepad(style="color: #DC40ED")
          ...
          li.d-flex
            i.fas.fa-gamepad(style="color: #DC40ED")
            p.mb-0 Nos ayuda a anticipar y localizar posibles bugs de manera más rápida y eficiente.
          li.d-flex
            i.fas.fa-gamepad(style="color: #DC40ED")
    ...
    p.mb-5(data-aos='fade-right') La clave está en mantener el equilibrio que las propias circunstancias de nuestro proyecto nos permitan. No se trata de hacer testing de todo o de nada, siempre va a ser mejor hacerlo de algunas partes que no hacerlo de nada. 
      br
      br
    ...
    .p-4(style="background-color: #FAE2FD ").adorno.mb-5
      .contenido
        ...
        .row.justify-content-center.align-items-center.mb-5
          ...
          .col-lg-9
            p.mb-0 En este ejercicio, a modo de ejemplo, se abordará la implementación de los siguientes casos de prueba que, aunque por definición no puedan considerarse 100 % tests unitarios, ya que contemplan el testeo de features más generales, son perfectamente válidos y servirán para ilustrar el desarrollo de tests (queda a criterio propio el plantear todos los casos que estimes necesarios):
        .row.justify-content-center.align-items-center.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-11(data-aos="fade-left")
        p.mb-0 #[span.morado [SetUp]:] este atributo, colocado encima de una de las funciones de su script de tests, específica a Unity que dicha función debe ser ejecutada antes de la ejecución de cada una de las funciones de test normales. 
        ...
        .col-lg-6
          ol.lista-ol--cuadro
            ...
            li.d-flex
              .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                span.fw-bold d
              p.mb-0 Limpiar la lista de checkpoints en escena.
          ...
          .col-lg-6
            ol.lista-ol--cuadro
              li.d-flex
                .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                  span.fw-bold a
                p.mb-0 Instanciar el prefab del checkpoint en el punto (100, 0, 0) de la escena, para que no esté tocando al player.

              li.d-flex
                .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                  span.fw-bold b
                p.mb-0 Obtener su componente CheckPoint, que es donde está el código que se quiere probar del juego (producción).

              li.d-flex
                .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                  span.fw-bold c
                p.mb-0 Esperar 0.1 segundos (esto es bastante común hacerlo en los tests cuando se quiere asegurar de darle tiempo a Unity para que refleje ciertas operaciones en la escena, en este caso la instancia del checkpoint).
              ...
              li.d-flex
                ...
                .contenido
                  p.mb-0 Esperar 0.1 segundos (esto es bastante común hacerlo en los tests cuando se quiere asegurar de darle tiempo a Unity para que refleje ciertas operaciones en la escena, en este caso la instancia del checkpoint).
                  p.ms-4 - El número de objetos en la lista de checkpoints en escena debe ser 1.
                    br
    ...
    ImagenInfografica.color-acento-botones.mb-5
      ...
      .tarjeta.p-3(x="15%" y="30%" numero="1" style="background-color: #E8EAFF ")
        .h5.mb-2 1. UnityTest
      ...
      .tarjeta.p-3(x="23%" y="33%" numero="2" style="background-color: #E8EAFF ")
      ...
      .tarjeta.p-3(x="18%" y="38%" numero="3" style="background-color: #E8EAFF ")
      ...
      .tarjeta.p-3(x="15%" y="60%" numero="4" style="background-color: #E8EAFF ")
        .h5.mb-2 
        p 
    ...
    p.fw-bold «La activación correcta de un checkpoint» y «El posicionamiento del player al último checkpoint después de morir»
    .row.justify-content-center.mb-5
