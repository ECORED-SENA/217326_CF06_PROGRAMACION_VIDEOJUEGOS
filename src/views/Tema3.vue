...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-5
        p Es importante mencionar que en este apartado aparte de las pruebas realizadas también se han considerado como pruebas los #[em logs] generados durante el desarrollo del proyecto, así como las ejecuciones en el editor como parte de la integración porque al tratarse de un juego, los elementos debían coordinarse a la perfección para no obtener #[em bugs] indeseados.
          br
          br
    ...
    figure.mb-5
      ...
      figcaption Video. #[em Framework Test Runner]
        ...
        .row.justify-content-center.align-items-center.mb-5
          ...
          .col-lg-6
            ul.lista-ul--color
              li.d-flex
                i.fas.fa-gamepad(style="color: #DC40ED")
                p.mb-0 Caso de prueba para que un #[em checkpoint] se cree correctamente.
              li.d-flex
                i.fas.fa-gamepad(style="color: #DC40ED")
                p.mb-0 Caso de prueba para que un #[em checkpoint] sea activado por el #[em player] correctamente.
              li.d-flex
                i.fas.fa-gamepad(style="color: #DC40ED")
                p.mb-0 Caso de prueba para que el #[em player], tras morir, sea teletransportado al último #[em checkpoint] activado.
        .row.justify-content-center.mb-5
          .col-lg-10
            .tarjeta.bg-white.p-5
              ...
              img(src='@/assets/curso/temas/52.png', alt='La imagen muestra una parte de código que pertenece a una clase en C# llamada CheckPointTests. Dentro de la clase, se declaran tres variables privadas de instancia: #[em player] y enemy, ambas del tipo GameObject, y newCheckPoint. Estas variables se usan en pruebas unitarias relacionadas con puntos de control en un juego, donde #[em player] y enemy son objetos del juego.')
        p Antes de iniciar a escribir el código del primer caso de prueba conviene señalar la existencia de 2 atributos especiales que van a ser útiles a la hora de implementar sus funciones de #[em test] en Unity.    
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-11(data-aos="fade-left")
        p.mb-0 <span class="morado"> [#[em SetUp]]:</span> este atributo, colocado encima de una de las funciones de su script de #[em tests], específica a Unity que dicha función debe ser ejecutada antes de la ejecución de cada una de las funciones de #[em test] normales. 
    p.mb-5(data-aos='fade-right') Esto permite, por ejemplo, crear e inicializar objetos comunes a todas las pruebas sin tener que estar realizándose al inicio de cada prueba. Por tanto, empiece por crear la función de #[em SetUp]:
    .row.justify-content-center.mb-5
      .col-lg-10
        img(src='@/assets/curso/temas/54.png', alt='Texto alternativo El código muestra el método #[em Setup] en C# para inicializar objetos de prueba en Unity. Se crean dos instancias de GameObject, #[em player] y enemy, sin gravedad, preparados para ser utilizados en pruebas unitarias.')
          ...
          ol.lista-ol--cuadro
            li.d-flex
              .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                span.fw-bold a
              div Instanciar el #[em prefab] del #[em player] en el punto (0, 0, 0) de la escena.
            li
              .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                span.fw-bold b
            ...
            li.d-flex
              .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                span.fw-bold c
              div Instanciar el #[em prefab] del enemigo en un punto alejado al #[em player] (200, 0, 0).
            li
              .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                span.fw-bold d
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-11(data-aos="fade-left")
        p.mb-0 <span class="morado "> <em> [TearDown]:</em> </span> este atributo, colocado encima de una de las funciones del script de #[em tests], específica a Unity que dicha función debe ser ejecutada después de la ejecución de cada una de las funciones de #[em test] normales. Esto permite, por ejemplo, destruir o limpiar objetos comunes a todas las pruebas sin tener que estar realizándose al final de cada prueba. Por tanto, debe crear la función de #[em TearDown:]
    .row.justify-content-center.mb-5
      .col-lg-10
        img(src='@/assets/curso/temas/57.png', alt='El código muestra un método #[em Teardown] en C#, etiquetado con [#[em TearDown]], que se usa para limpiar recursos después de que se ejecutan las pruebas unitarias. Se destruyen los objetos #[em player], enemy, y newCheckPoint, y se limpia una lista de ')
    p.mb-5(data-aos='fade-right') En este caso se hace lo siguiente:
    .mn.p-5.bg-4.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-6
          ol.lista-ol--cuadro
            li.d-flex
              .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                span.fw-bold a
              p.mb-0 Destruir el objeto instanciado del #[em player].
    ...
    p.mb-5(data-aos='fade-right') Bien, ya puede empezar a escribir sus 3 casos de prueba.
      br
      br
      |#[span.morado Empecemos con el primero:] la creación correcta de un #[em checkpoint] en escena.
    .row.justify-content-center.mb-5
          ...
          .col-lg-6
            ol.lista-ol--cuadro
              li.d-flex
                .lista-ol--cuadro__vineta(style="background-color: #DC40ED")
                  span.fw-bold a
                p.mb-0 Instanciar el #[em prefab] del #[em checkpoint] en el punto (100, 0, 0) de la escena, para que no esté tocando al #[em player].
    ...
    ImagenInfografica.color-acento-botones.mb-5
      ...
      .tarjeta.p-3(x="8%" y="30%" numero="1" style="background-color: #E8EAFF ")
        .h5.mb-2 1. UnityTest
        p Este atributo lo usará en cada una de las funciones de #[em test] y le indica a Unity que es uno de los #[em test] y que debe ejecutarlo dentro de su #[em Test] Suite correspondiente.
      .tarjeta.p-3(x="13%" y="33%" numero="2" style="background-color: #E8EAFF ")
        .h5.mb-2 2. heckPointIsCreatedProperly
        p Es el nombre de la función y siempre es recomendable que los nombres de las funciones referentes a sus #[em tests] sean lo más claros e intuitivos posible, por tanto no se preocupe si queda un nombre demasiado largo.
      .tarjeta.p-3(x="10%" y="38%" numero="3" style="background-color: #E8EAFF ")
        .h5.mb-2 3. IEnumerator
        p Las funciones de #[em test] pueden no devolver nada o pueden también devolver un IEnumerator (convirtiéndose en corrutinas). En este caso hemos necesitado que se comporte como corrutina debido a la espera de 0.1 segundos que hacemos en el paso 3 de nuestra lógica.
      .tarjeta.p-3(x="10%" y="60%" numero="4" style="background-color: #E8EAFF ")
        .h5.mb-2 
        p 
    p.mb-5(data-aos='fade-right') A partir de ahora ya maneja lo básico y necesario para realizar cualquier tipo de #[em test]. Así que acabemos de ver los siguientes casos de prueba: 
      ...
      .col-lg-10
        .p-4(style="background-color: #1425DD ")
          .row.justify-content-center.align-items-center
            ...
            .col-lg-11
              p.mb-0.text-white #[b Nota:] como vemos, dentro de una función de #[em test], podemos perfectamente hacer llamadas a otras funciones de #[em test] siempre y cuando tenga sentido para nuestras pruebas.
    .titulotres.mb-4
    ...
    figure.mb-4
      ...
      figcaption Video. #[em Script TestRunner]
    .row.justify-content-center.mb-5
      .col-lg-10
        .tarjeta(style="background-color: #E8EAFF").p-5
          p.text-center.fw-bold.mb-0 ¡Disfruta del #[em testing]!
